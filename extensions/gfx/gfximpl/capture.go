...
func (s *captureState) arm(request gfx.ArmCaptureRequest) (*captureRequest, error) {
	...
	switch {
	case amount > internal.MaxCaptureAmount:
		return nil, gfx.ErrCaptureAmount{Amount: amount, Max: internal.MaxCaptureAmount}
	case amount*interval > internal.MaxCaptureSpan:
		return nil, gfx.ErrCaptureSpan{Ticks: amount * interval, Max: internal.MaxCaptureSpan}
