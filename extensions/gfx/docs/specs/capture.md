...
[extensions/gfx/docs/specs/mcp.md](./mcp.md). Nothing below the `Backend` seam knows an
agent exists.
...
in [extensions/gfx/docs/specs/mcp.md](./mcp.md), and it is ordinary `gfx` API: anything
