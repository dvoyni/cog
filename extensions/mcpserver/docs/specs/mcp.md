...
`github.com/dvoyni/cog/extensions/mcpserver` is the one plugin that collects capabilities
...
serves is
[extensions/mcp/docs/specs/mcp.md](../../../mcp/docs/specs/mcp.md), which is
...
**`extensions/mcpserver/plugin.go`**
