...
// visual into canvas. The plugin holds one as its private resource; Measure builds a
// throwaway one. It is not part of ui's public API, so what the plugin calls on it is
