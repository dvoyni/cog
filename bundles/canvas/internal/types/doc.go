...
// OpQueue and Lookup, with their recording and measuring methods; the consume
// side of the queue; the sprite and glyph atlases, the font store and
// inline-text parsing; Config, which the atlases hold; the halo profile; and the
// built-in materials.
//
...
// friends.go. The types only internal/ ever holds (LayerOps, DrawOp, Atlas, Font
