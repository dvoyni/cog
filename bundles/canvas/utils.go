...
func LayerTransform(window m.Rect, aspect AspectMode, viewport m.Vec2) (scale, offset m.Vec2) {
	return types.LayerTransform(window, aspect, viewport)
}
...
func WorldToScreen(window m.Rect, aspect AspectMode, viewport, world m.Vec2) m.Vec2 {
	return types.WorldToScreen(window, aspect, viewport, world)
}
...
func ScreenToWorld(window m.Rect, aspect AspectMode, viewport, screen m.Vec2) m.Vec2 {
	return types.ScreenToWorld(window, aspect, viewport, screen)
}
...
func DefaultKeyColor() m.Color { return types.DefaultKeyColor() }
...
func DefaultMaterial() *gfx.MaterialDescr { return types.DefaultMaterial() }
...
func DefaultTrianglesMaterial() *gfx.MaterialDescr { return types.DefaultTrianglesMaterial() }
...
func TextureMaterial() *gfx.MaterialDescr { return types.TextureMaterial() }
...
// edit.
func DefaultHaloProfile() HaloProfile { return types.DefaultHaloProfile() }
...
// in.
func HaloMaterialSet(profile HaloProfile) MaterialSet { return types.HaloMaterialSet(profile) }
