...
var (
	...
	materialRecordSize = int(unsafe.Sizeof(internal.ScenePbrRecord{}))
	meshRecordSize     = int(unsafe.Sizeof(internal.SceneMesh{}))
)
...
func (b *frameBuild) reset() {
	...
	b.meshes.appendElement(&internal.IdentityMesh)
	b.passes = b.passes[:0]
	b.draws = b.draws[:0]
...
func (b *frameBuild) addDraw(
	pass *pendingPass, mesh internal.MeshRecord, id uint32, entry materialEntry,
	worlds []m.Mat4, record internal.ScenePbrRecord, params []gfx.ParameterDescr, anim internal.AnimBinding,
) {
...
func (b *frameBuild) meshIndex(record internal.SceneMesh) uint32 {
	if record == (internal.SceneMesh{}) {
		return 0
	}
