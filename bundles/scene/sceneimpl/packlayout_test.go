...
func TestEveryUploadedRecordMatchesItsShaderStruct(t *testing.T) {
	...
	var mesh internal.SceneMesh
	var pbr internal.ScenePbrRecord
...
func pbrMembers(pbr *internal.ScenePbrRecord) []shaderMember {
	members := []shaderMember{
	...
	for slot, descr := range internal.PbrSlots {
