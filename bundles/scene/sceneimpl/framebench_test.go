...
func frameBenchMaterial(defaults internal.PbrDefaults) (scene.Material, []gfx.ParameterDescr) {
	...
	for i, slot := range internal.PbrSlots {
		texture := defaults.White
		if i == internal.NormalSlot {
