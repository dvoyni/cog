...
// Config is scene's configuration; see scene.Config. It is declared here because
// the Lookup resource holds it, and the root aliases it.
type Config struct {
...
// WithDefaults fills every zero field of config with the value scene runs with
