...
`^#-?[0-9]+$`; see
[bundles/input/docs/specs/mcp.md](../../../../bundles/input/docs/specs/mcp.md).
...
- **Arbitrary command dispatch by type name.** The agent reaches the game through
  ...
  `extensions/gfx/plugin.go` ([#210](https://github.com/dvoyni/cog/issues/210) §8).
