...
// bundles/input/docs/specs/mcp.md so it is reviewed as prompt text rather than buried
// as a string literal.
...
// stateDescription is prompt text, reproduced in bundles/input/docs/specs/mcp.md for
// the same reason.
