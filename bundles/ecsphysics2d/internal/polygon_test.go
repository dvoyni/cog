...
// stackGravity is the Force a 1 kg Body is pushed by in these scenes, which is
// what makes a stack settle rather than float. It is the app's own write, added
// Before[IntegrateOnUpdate] like any other. It is a signed Force, and named
// apart from material_test.go's gravity, which is an acceleration magnitude.
const stackGravity = -9.8
