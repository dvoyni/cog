...
// Register resolves the settings, declares the six Components a Body is made of
// and the Joint that holds two of them, publishes the two indices and the two
// solver Resources, and chains the four Systems in cp's order.
//
