...
// mainLoopAdapter provides app's MainLoop to the engines these tests compose,
// the way a platform plugin provides its own: app is a Slot, and a composition
...
func (mainLoopAdapter) Name() kernel.PluginName           { return "physicstestmainloop" }
