...
func NewTransform(a, c, tx, b, d, ty float64) Transform {
	return internal.NewTransform(a, c, tx, b, d, ty)
}

// NewTransformIdentity is the transform that changes nothing.
func NewTransformIdentity() Transform { return internal.NewTransformIdentity() }

// NewTransformTranslate moves by a vector.
func NewTransformTranslate(translate m.Vec2d) Transform {
	return internal.NewTransformTranslate(translate)
}

// NewTransformScale scales each axis.
func NewTransformScale(scaleX, scaleY float64) Transform {
	return internal.NewTransformScale(scaleX, scaleY)
}

// NewTransformRotate turns by an angle in radians.
func NewTransformRotate(radians float64) Transform { return internal.NewTransformRotate(radians) }
...
func NewTransformRigid(translate m.Vec2d, radians float64) Transform {
	return internal.NewTransformRigid(translate, radians)
}

// NewTransformRigidInverse undoes a rigid transform without a divide.
func NewTransformRigidInverse(t Transform) Transform { return internal.NewTransformRigidInverse(t) }

// NewBB is the box with those four edges: left, bottom, right, top.
func NewBB(l, b, r, t float64) BB { return internal.NewBB(l, b, r, t) }
...
func NewCircleShape(radius float64, offset m.Vec2d) Shape {
	return internal.NewCircleShape(radius, offset)
}
...
func NewSegmentShape(a, b m.Vec2d, radius float64) Shape {
	return internal.NewSegmentShape(a, b, radius)
}
...
func NewSegmentShapeWithNeighbours(previous, a, b, next m.Vec2d, radius float64) Shape {
	return internal.NewSegmentShapeWithNeighbours(previous, a, b, next, radius)
}
...
func NewPolygonShape(verts []m.Vec2d, radius float64) (Shape, Polygon, error) {
	return internal.NewPolygonShape(verts, radius)
}
...
func NewBoxShape(width, height, radius float64) Shape {
	return internal.NewBoxShape(width, height, radius)
}
...
func NewBoxShapeFor(box BB, radius float64) Shape {
	return internal.NewBoxShapeFor(box, radius)
}
...
func PolygonVerts(dst []m.Vec2d, shape Shape, polygon Polygon) []m.Vec2d {
	return internal.PolygonVerts(dst, shape, polygon)
}
...
func NewPinJoint(a, b ecs.Entity, anchorA, anchorB m.Vec2d, distance float64) Joint {
	return internal.NewPinJoint(a, b, anchorA, anchorB, distance)
}
...
func PinDistance(
	...
	return internal.PinDistance(posA, angleA, anchorA, posB, angleB, anchorB)
}
...
func NewSlideJoint(a, b ecs.Entity, anchorA, anchorB m.Vec2d, minimum, maximum float64) Joint {
	return internal.NewSlideJoint(a, b, anchorA, anchorB, minimum, maximum)
}
...
func NewPivotJoint(a, b ecs.Entity, anchorA, anchorB m.Vec2d) Joint {
	return internal.NewPivotJoint(a, b, anchorA, anchorB)
}
...
func PivotAnchors(
	...
	return internal.PivotAnchors(posA, angleA, posB, angleB, worldPivot)
}
...
func NewGrooveJoint(a, b ecs.Entity, anchorA, start, end m.Vec2d) Joint {
	return internal.NewGrooveJoint(a, b, anchorA, start, end)
}
...
func NewSpringJoint(
	...
	return internal.NewSpringJoint(a, b, anchorA, anchorB, restLength, stiffness, absorption)
}
...
func NewRotarySpringJoint(a, b ecs.Entity, restAngle, stiffness, absorption float64) Joint {
	return internal.NewRotarySpringJoint(a, b, restAngle, stiffness, absorption)
}
...
func NewRotaryLimitJoint(a, b ecs.Entity, minimum, maximum float64) Joint {
	return internal.NewRotaryLimitJoint(a, b, minimum, maximum)
}
...
func NewRatchetJoint(a, b ecs.Entity, angle, phase, ratchet float64) Joint {
	return internal.NewRatchetJoint(a, b, angle, phase, ratchet)
}
...
func NewGearJoint(a, b ecs.Entity, phase, ratio float64) Joint {
	return internal.NewGearJoint(a, b, phase, ratio)
}
...
func NewStaticIndex(cellSize float64) *StaticIndex { return internal.NewStaticIndex(cellSize) }

// NewBodyIndex is an empty Body index with that cell size in metres, with the
// same default as NewStaticIndex.
func NewBodyIndex(cellSize float64) *BodyIndex { return internal.NewBodyIndex(cellSize) }
...
func ProbeShape(
	...
	return internal.ProbeShape(from, to, radius, shape, at, angle, verts)
}
...
func ProbeShapeWith(
	...
	return internal.ProbeShapeWith(mover, from, to, angle, moverVerts, target, at, targetAngle, targetVerts)
}
...
func Penetration(
	...
	return internal.Penetration(a, atA, angleA, vertsA, b, atB, angleB, vertsB)
}
...
func ClosestPoint(p m.Vec2d, shape Shape, at m.Vec2d, angle float64, verts []m.Vec2d) m.Vec2d {
	return internal.ClosestPoint(p, shape, at, angle, verts)
}
...
func MomentForCircle(mass, r1, r2 float64, offset m.Vec2d) float64 {
	return internal.MomentForCircle(mass, r1, r2, offset)
}
...
func MomentForPoly(mass float64, verts []m.Vec2d, offset m.Vec2d, radius float64) float64 {
	return internal.MomentForPoly(mass, verts, offset, radius)
}
...
func AreaForCircle(r1, r2 float64) float64 { return internal.AreaForCircle(r1, r2) }
...
func AreaForSegment(a, b m.Vec2d, radius float64) float64 {
	return internal.AreaForSegment(a, b, radius)
}
...
func AreaForPoly(verts []m.Vec2d, radius float64) float64 {
	return internal.AreaForPoly(verts, radius)
}
...
func CentroidForPoly(verts []m.Vec2d) (m.Vec2d, bool) { return internal.CentroidForPoly(verts) }
...
func NewDynamic(mass, moment, damping, angularDamping float64) (Dynamic, error) {
	return internal.NewDynamic(mass, moment, damping, angularDamping)
}
...
func NewDynamicForShape(shape Shape, polygon Polygon, density, damping, angularDamping float64) (Dynamic, Shape, Polygon, m.Vec2d, error) {
	return internal.NewDynamicForShape(shape, polygon, density, damping, angularDamping)
}
