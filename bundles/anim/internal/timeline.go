...
// Timeline is one chain of tracks and cues with its own clock; see the anim
// package documentation for the chain-point model. It is not a resource of its own:
