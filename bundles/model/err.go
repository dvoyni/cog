...
type ErrModelTextureUnavailable = internal.ErrModelTextureUnavailable
...
type ErrModelPrimitiveSkipped = internal.ErrModelPrimitiveSkipped
...
type ErrModelBoundsMissing = internal.ErrModelBoundsMissing
...
type ErrModelNodeDuplicated = internal.ErrModelNodeDuplicated
...
type ErrModelSkinUnbound = internal.ErrModelSkinUnbound
...
// call that caused it.
type ErrModelUnavailable = internal.ErrModelUnavailable
...
type ErrModelPathInvalid = internal.ErrModelPathInvalid
...
type ErrModelSceneMissing = internal.ErrModelSceneMissing
...
// failure of the two.
type ErrModelNodeMissing = internal.ErrModelNodeMissing
...
// put it.
type ErrModelNodeDegenerate = internal.ErrModelNodeDegenerate
...
type ErrModelPoseApproximated = internal.ErrModelPoseApproximated
...
type ErrModelClipMissing = internal.ErrModelClipMissing
...
type ErrModelPlaysOverLimit = internal.ErrModelPlaysOverLimit

// ErrClipMachineEmpty reports a ClipMachine built with no states, which leaves
// it nothing to start in.
type ErrClipMachineEmpty = internal.ErrClipMachineEmpty
...
type ErrClipStateClipMissing = internal.ErrClipStateClipMissing
...
type ErrClipTransitionStateMissing = internal.ErrClipTransitionStateMissing

// ErrClipTransitionTriggerInvalid reports a ClipTransition with both On and
// OnFinish set, or neither.
type ErrClipTransitionTriggerInvalid = internal.ErrClipTransitionTriggerInvalid
...
type ErrModelMorphWeightsOverLength = internal.ErrModelMorphWeightsOverLength
...
type ErrModelMorphTargetsOverLimit = internal.ErrModelMorphTargetsOverLimit
...
type ErrTextureUVSetUnsupported = internal.ErrTextureUVSetUnsupported
...
type ErrMeshGeometryInvalid = internal.ErrMeshGeometryInvalid
...
type ErrMeshUnavailable = internal.ErrMeshUnavailable
...
type ErrMeshUpdateRejected = internal.ErrMeshUpdateRejected
...
// one reads as pi/4.
type ErrSpotConeInverted = internal.ErrSpotConeInverted
