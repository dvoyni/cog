...
//
// The authority is created here, from Config, and nowhere else. The plugins that
...
// on ecs: that is what registers ecs, and so the authority, first.
//
...
// second Entities.
func Plugin() kernel.Plugin { return plugin{} }
