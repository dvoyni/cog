...
func RegisterComponent[C any](registrar *kernel.Registrar, ids uint32) *Store[C] {
	return internal.RegisterComponent[C](registrar, ids)
}
...
func NewStore[T any](en *Entities, ids uint32) *Store[T] { return internal.NewStore[T](en, ids) }
...
func Storable(t reflect.Type) error { return internal.Storable(t) }
...
// of those.
func PointerFree(t reflect.Type) error { return internal.PointerFree(t) }
...
// registration, naming the System, and is reported as kernel.ErrPluginPanic
// naming the plugin.
func ToHandler[E any](
	registrar *kernel.Registrar, system any, feeds ...Feeder[E],
) func() (kernel.Lock, kernel.Observe[E]) {
	return internal.ToHandler[E](registrar, system, feeds...)
}
...
func ToExecute[Req any, Res any](
	...
	return internal.ToExecute[Req, Res](registrar, system, feeds...)
}
...
func Feed[E any, T any](project func(E) T) Feeder[E] { return internal.Feed[E, T](project) }
