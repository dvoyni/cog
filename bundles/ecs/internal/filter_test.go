...
func TestTheFillSkipsFilterFields(t *testing.T) {
	...
	e := entities.alloc()
	components.bodies.Set(e, body{})
	components.velocities.Set(e, typesVelocity{X: 3, Y: 5})
...
func TestAWithoutIsNeverTheDriver(t *testing.T) {
	...
	components.velocities.Set(tagged, typesVelocity{X: 1})
