...
// decimal handle. It is unexported, with no forwarder in the root, because
// reading an Entity back in code is what the type refuses; only a caller
// outside Go has nothing but the string.
