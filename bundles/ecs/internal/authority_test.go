...
// typesName is the ecs plugin's name, the same Name this package declares and
// the root aliases, spelled again for this package's tests; every plugin they
// compose depends on it.
const typesName kernel.PluginName = "ecs"
...
func (authority) Name() kernel.PluginName { return typesName }
