...
| hand-written subscription, 1 000 | 6 516 | **6** | 322 |
| **a System with a two-Component Query, 1 000** | **10 061** | **6** | 322 |
| …the same Query with a `Without`, a third tagged, 1 000 | 10 331 | **6** | 322 |
| hand-written subscription, 10 000 | 22 620 | **6** | 322 |
| **a System with a two-Component Query, 10 000** | **33 623** | **6** | 321 |
| …the same Query with a `Without`, a third tagged, 10 000 | 33 788 | **6** | 322 |
