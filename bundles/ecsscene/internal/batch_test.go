...
// key, so they are one instanced draw of five thousand, where scene's one call
// per Entity was five thousand draws. Tinting all of them the same red keeps
...
// thousand Batches of one, as in scene, and each draws its own tint.
