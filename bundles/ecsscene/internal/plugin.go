...
// The debug shapes' Systems after the first, which is ecsscene.DebugOnUpdate.
...
// Systems, chained one after another from ecsscene.DebugOnUpdate and every
// one before ecsscene.LoadOnUpdate. The chain costs no parallelism: every one
