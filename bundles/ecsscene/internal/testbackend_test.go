...
// asked the GPU to do, modelled on scene's own. It is the oracle every drawing
// test here asserts against: the binding is judged by what reached gfx, not by
// anything scene or ecsscene would have to publish for inspection.
//
