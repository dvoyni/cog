...
func ToHandler[E any](en *Entities, system any) func() (kernel.Lock, kernel.Observe[E]) {
	...
	return func() (kernel.Lock, kernel.Observe[E]) {
		return func(access kernel.ResourceAccess) {
				...
				//
				// A Spawn or a WriteableEntities promotes it below, and the write
				// supersedes this read rather than sitting beside it — which is
				// what makes a structural change a total barrier.
