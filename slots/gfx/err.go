...
type ErrVertexInputUnsupplied = types.ErrVertexInputUnsupplied
...
type ErrVertexInputMismatch = types.ErrVertexInputMismatch
...
type ErrShaderSource = types.ErrShaderSource
