...
// slots/gfx/docs/specs/mcp.md so it is reviewed as prompt text rather than buried as
// a string literal.
...
//
// Capture is screen-only: gfx.CaptureDesc addresses any colour texture and that
