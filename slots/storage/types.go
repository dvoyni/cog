...
import "github.com/dvoyni/cog/slots/storage/internal/types"

// MountId identifies a filesystem mounted in FileSystem.
type MountId = types.MountId
...
type ReadMount = types.ReadMount
...
const (
	...
	PermanentMount MountId = types.PermanentMount
